...
{/*!This is a constructor function which sets up the objects of rude-goldberg machine.*/
  dominos_t::dominos_t()
  {
    ...
    //!##The pulley system
    {
      ...
      fd1->density = 25.0;	  //changes to 44
    ...
    //simple rotating platform
    {
      ...
      b2PulleyJointDef* myjoint = new b2PulleyJointDef();
      b2Vec2 worldAnchorOnBody1(-8,10); 
      b2Vec2 worldAnchorOnBody2(-4, 12); 
      b2Vec2 worldAnchorGround1(-8, 17);
      b2Vec2 worldAnchorGround2(-4, 17);
      float32 ratio = 1.0f;
